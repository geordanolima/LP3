 ...
 */
public class JanelaArma extends javax.swing.JFrame {

    /**
     * Creates new form JanelaArma
     */
    public JanelaArma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar arma:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jSpinner3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    //campos janela criar arma
        
        arma.setNome(jTextField1.getText());
        arma.setDescricao(jTextField2.getText());
        arma.setAtaque(Integer.parseInt(jSpinner1.getValue().toString()));
        arma.setDefesa(Integer.parseInt(jSpinner2.getValue().toString()));
        arma.setVida(Integer.parseInt(jSpinner3.getValue().toString()));
        arma.setCaminho(jTextField3.getText()); //pasta
        arma.setIniciativa(Integer.parseInt(jSpinner4.getValue().toString()));        
    //inicio gravaçao
    ...
    jSpinner3=null;
    //mensagem tela
        JOptionPane.showMessageDialog(null, "Arma gravada com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaArma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaArma().setVisible(true);
            }
        });
    }
